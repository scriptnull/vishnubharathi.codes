...
- I keep on hearing about "Deterministic Simulation Testing" used in the [TigerBeetle](https://github.com/tigerbeetle/tigerbeetle) project. I wonder what it is and what are the other methods to test distributed systems.
